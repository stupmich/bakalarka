...
public class LightManager : MonoBehaviour
{
    ...
    [SerializeField] private Material transitionSkybox;
    ...
    private void UpdateLighting(float timePercent)
    {
        ...
        if ((timePercent >= 0.15f && timePercent <= 0.25f) || (timePercent >= 0.75f && timePercent <= 0.85f))
        {
            RenderSettings.skybox = transitionSkybox;
        } else if (timePercent > 0.25f && timePercent < 0.75f)
        {
